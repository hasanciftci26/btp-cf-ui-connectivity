		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Connectivity",
									"targetURL": "#ndbsconnectivityui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbsconnectivityui-display": {
								"semanticObject": "ndbsconnectivityui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.connectivityui",
									"url": sap.ui.require.toUrl("ndbs/connectivityui")
								}
							}
						}
					}
